                    ...
                    <div class="text-end mb-4">
                        <div class="table-responsive">
                            <table class="table table-hover border text-center" style="min-width: 1300px;">
                                ...
                                <?php
                                $query="select * from property where status='deny' order by property_id asc";
...
query;
                    ...
                    if (isset($_POST['approval'])){
                        $id=$_POST['id'];
                        $select="update property set status='approved' where property_id='$id'";
                    ...
                    if (isset($_POST['deny'])){
                        $id=$_POST['id'];
                        $select="delete from property where property_id='$id'";
                        $result=mysqli_query($con,$select);
                        echo '<script  type="text/javascript">';
                        echo 'alert("Rejected!")';
                        echo '</script>';}
